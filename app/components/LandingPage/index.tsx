...
export default function LandingPage() {
  ...
  return (
    <>
      <main className="relative grid h-[calc(60vh-8rem)] min-h-[460px] w-full lg:place-items-start object-cover">
        <Image
          src={HomeBanner}
          alt="Home Banner"
        ...
        <div className="z-[3] flex flex-col items-center justify-center lg:items-start lg:mt-14 lg:justify-start h-full px-8 lg:px-16">
          <h1 className="lg:text-5xl md:text-3xl text-2xl lg:text-left text-center font-semibold text-primaryText">
            Providing Reliable Programs <br />
            <span className="lg:my-5 my-3 block">
              Ensuring You&apos;re Protected
            </span>{" "}
            <span className="block">Every Step Of The Way</span>
          </h1>
          <p className="text-primaryText lg:mt-8 mt-5 font-thin lg:text-2xl text-xl font-[Inter]">
      ...
      <section className="m-8">
        <div className="flex flex-col justify-center items-center my-5">
          <h1 className="text-primary font-bold text-3xl lg:text-5xl md:text-4xl my-4">
            About Us
          </h1>
        </div>
        <div className="flex lg:flex-row flex-col-reverse justify-center items-center">
          ...
          <div className="flex flex-col justify-start items-center">
            <h1 className="text-secondaryText font-bold text-3xl lg:text-5xl md:text-4xl my-4">
              Waypoint Offers
            </h1>
            <ul className="custom-circle-list lg:w-[550px] w-fit">
              {offers.map((offer: string, index: number) => (
                <li
                  key={index}
                  className="my-5 lg:text-3xl md:text-2xl text-xl font-medium"
                >
                  {offer}
                </li>
              ))}
      ...
      <section className="bg-[#FDFFFC] p-1 mx-5">
        <h4 className="flex flex-col justify-center items-center my-6 text-center">
          ...
          <p className="text-secondaryText lg:text-5xl md:text-3xl text-2xl py-2">
            your
            <span className="text-primary lg:text-5xl font-bold md:text-3xl text-2xl">
              {" "}
              Long-Term Goals
            </span>
          </p>
