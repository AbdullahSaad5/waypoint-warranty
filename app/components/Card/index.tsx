...
const Card: React.FC<CardProps> = ({ number, icon, title, description }) => {
  return (
    <div className="mx-5">
      <div className="card group rounded-md bg-base-100 lg:w-96 shadow-md lg:h-[320px] md:w-[310px] w-[300px] hover:bg-darkBlue">
        <div className="flex justify-between items-center p-2 mx-3">
          <span className="font-normal text-4xl text-gray-400 group-hover:text-primaryText">
            {number}
          </span>
        ...
        <div className="card-body mt-0 pt-5 text-center flex justify-center items-center ">
          ...
          <p className="text-gray-400 font-medium group-hover:text-primaryText">
            {description}
          </p>
        </div>
      </div>
