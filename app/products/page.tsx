    ...
    <>
      <main className="flex flex-col lg:flex-row justify-center items-center lg:space-x-10 p-5 px-10">
        <div className="flex flex-col justify-start items-center">
          <h1>
            <p className="lg:text-7xl md:text-6xl text-5xl font-bold">Waypoint </p>
            <span className="lg:text-5xl md:text-4xl text-3xl font-bold">Warranty </span>
            <span className="lg:text-5xl md:text-4xl text-3xl font-bold text-blue">Products</span>
          </h1>
        ...
        <div className="relative w-[90vw] lg:w-[50vw] h-[60vh] p-10 ">
          <div>
            <Image src={Image3} alt="Car Image" className="object-cover h-[50vh]" />
          </div>
          <svg
            width="29"
            height="45"
          ...
          >
            <path d="M0.000125885 16.2792L28.1965 6.41938e-05L16.2793 44.4756L0.000125885 16.2792Z" fill="#4D9CFF" />
          </svg>
          <svg
            width="30"
            height="38"
          ...
          >
            <path d="M29.371 29.6067L0.393245 37.3713L21.6064 0.628906L29.371 29.6067Z" fill="#4D9CFF" />
          </svg>
          <svg
            width="40"
            height="40"
