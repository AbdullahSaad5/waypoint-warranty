  ...
  const cards: CardProps[] = [
    {
        ...
        <svg width="80" height="80" viewBox="0 0 95 95" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <defs>
            <clipPath id="clip0_251_943">
              <rect width="76" height="76" fill="white" transform="translate(10 9)" />
            </clipPath>
          </defs>
        </svg>
      ),
      ...
      description:
        "Most transparent programs in the industry, eliminating unnecessary taxes and fees for greater investment income",
    },
    {
      number: "02",
      icon: (
        <svg width="80" height="80" viewBox="0 0 95 95" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g clipPath="url(#clip0_251_951)">
            <path d="M49.5 18.5V78.625" stroke="#1F60B2" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" />
            <path
    ...
    <>
      <main className="relative grid h-[calc(60vh-8rem)] min-h-[420px] w-full place-items-center object-cover">
        ...
        <div className="container z-[3] flex h-full items-center text-center lg:text-left flex-col lg:items-start text-primaryText px-4 pt-11 font-[Inter] lg:pl-10">
          <h1 className="lg:text-4xl text-3xl font-semibold">Become a Waypoint Dealer</h1>
          <span className="max-w-lg text-sm lg:text-base mt-4">
            As an administrative partner who was founded by dealers, we understand the specific needs of a dealer, and
            the ever-changing and demanding needs of your customers. We offer products and a claims experience that will
            allow you to provide your customers with the products they want, and claims that allows you to focus on your
            growth. Fill out the form below if you are interested in becoming a trusted partner with Waypoint Warranty
            Solutions and learn more about us.
          </span>
          <span className="font-semibold absolute text-xl bottom-5">Home {">"} Dealers</span>
        </div>
      </main>
      ...
      <section className="bg-secondaryBg">
        <div className="flex flex-col justify-center items-center">
          <h1 className="text-primary font-bold text-3xl lg:text-5xl my-4">Our Products</h1>
        </div>
