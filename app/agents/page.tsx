...
export default function Agent() {
  ...
  const cards: CardProps[] = [
    ...
    },
    {
      ...
      description:
        "The first in the industry to create participation programs for select agent partners, allowing you to participate in the last dollars of the transaction where no other administrative partners will.",
    },
    {
      number: "04",
      icon: (
      ...
      description:
        "With Waypoint, you will always have a guide with you every step of the way, working with your dealers to maximize their opportunities, while helping you to focus on your own, growing your business as a true partner should.",
    },
  ];
  return (
    <>
      <main className="relative grid h-[calc(60vh-8rem)] min-h-[420px] w-full place-items-center object-cover">
        ...
        <div className="container z-[3] flex h-full items-center text-center lg:text-left flex-col lg:items-start text-primaryText px-4 pt-11 font-[Inter] lg:pl-10">
          <h1 className="lg:text-4xl text-3xl font-semibold">Become a Waypoint Agent</h1>
          <span className="max-w-lg text-sm lg:text-base mt-4">
            We value your partnership; we respect and support your business as if it were our own. When you become an
            agent with Waypoint, you gain access to a full suite of cutting-edge products and services to ensure your
            ongoing growth and success. Fill out the form below if you are interested in becoming a trusted partner with
            Waypoint Warranty Solutions and learn more about us.
          </span>
          <span className="font-semibold text-xl absolute bottom-5">Home {">"} Agents</span>
        </div>
      </main>
      <section className="bg-secondaryBg m-1 p-1">
        <div className="flex flex-col justify-center items-center my-3">
          <h1 className="text-primary font-bold text-3xl lg:text-5xl my-4">Benefits For Agents</h1>
        </div>
      ...
      <section className="bg-primaryBg ">
        <div className="flex justify-center items-center">
          <h2 className="text-primary mt-6 lg:text-5xl md:text-4xl text-3xl font-semibold">Signup as an Agent</h2>
        </div>
        <Form />
      </section>
    </>
