  ...
  return (
    <>
      <main className="relative grid h-[calc(60vh-8rem)] min-h-[420px] w-full place-items-center object-cover">
        ...
        <div
          className={`container z-[3] flex h-full items-center text-center lg:text-left flex-col lg:items-start text-primaryText px-4 pt-11 ${inter.className} lg:pl-10`}
        >
